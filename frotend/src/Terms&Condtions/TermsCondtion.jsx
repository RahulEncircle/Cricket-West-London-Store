  ...
  return (
    <div className="terms-container">
      ...
      <div className="terms-content">
        <p>
          Thank you for shopping with Cricket West London Store! We appreciate your business
        ...
        <p>
          ...
          agreed to in writing by Cricket West London Store.
        </p>
        <h2>Orders</h2>
        <p>
          All orders are subject to Cricket West London Store's acceptance. We may refuse to
        ...
        <p>
          ...
          Cricket West London Store. Prices displayed on the website exclude shipping
          ...
          from those in physical stores that stock Cricket West London Store products. We
        ...
        <p>
          ...
          taxes, except for those based on Cricket West London Store's income. If
          Cricket West London Store is required to collect and pay taxes on Customer's
        ...
        <p>
          ...
          order without Cricket West London Store's written consent. You may return products
        ...
        <p>
          You agree to indemnify and hold Cricket West London Store harmless from any
          claims, costs, proceedings, losses, or demands arising from your
          breach of these Terms or anyone using your account.
        </p>
        <h2>Entire Agreement</h2>
        <p>
          These Terms constitute the entire agreement between Cricket West London Store and
