      ...
      <div className={classes.about_us}>
          ...
          <Grid container spacing={4} justifyContent="center">
            ...
            <Grid item xs={12} sm={6}>
              ...
              <Typography variant="body1" className={classes.introText_about}>
                Cricket West London Store store is an online cricket sports selling startup
                started in 2024. We have served more than 20,000 customers
              ...
              <Typography variant="body1" className={classes.introText_about}>
                Cricket West London Store was founded by Lokesh Samant, a talented cricket
        ...
        <Container className={classes.container_12}>
          ...
          <Typography variant="body1" className={classes.infoText_about}>
            Cricket West London Store is dedicated to providing high-quality cricket
          ...
          <Typography variant="body1" className={classes.infoText_about}>
            Since our inception in 2024, we have built a strong customer base
          ...
          <Typography variant="body1" className={classes.infoText_about}>
            At Cricket West London Store, we believe in fostering long-term relationships
        ...
        <Container className={classes.container_12}>
          ...
          <Typography variant="body1" className={classes.infoText_about}>
            Cricket West London Store is driven by the mission to provide high-quality
