    ...
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        ...
        <p>
          ...
          experience purchasing from our webstore, CricketWestLondonStore.com
        </p>
        <p>
        ...
        <p>
          You (“Customer”) may place orders for Products with Cricket West London Store
          ...
          agreed to or set forth in writing by Cricket West London Store, any term or
        ...
        <h2>Orders</h2>
        <p>
          All orders are subject to Cricket West London Store's acceptance. This means
          Cricket West London Store may, for any reason, refuse to accept or may cancel or
          ...
          cancel an order after you have already been charged, Cricket West London Store
        ...
        <p>
          ...
          and it is accepted by Cricket West London Store. Prices for products displayed on
          ...
          website may differ from those in stores that stock Cricket West London Store
          products, as these stores are independent of Cricket West London Store.
          Cricket West London Store reserves the right to amend pricing for any pricing
          ...
          submitted an online order, Cricket West London Store will notify you of the error
        ...
        <p>
          ...
          Cricket West London Store reserves the right to change or discontinue such offers
          at any time.
        </p>
        <h2>Taxes</h2>
        <p>
          The prices quoted for the products sold hereunder include applicable
          taxes. Customer shall pay, and reimburse Cricket West London Store if it pays, any
          taxes, except for those based on Cricket West London Store's income.
        </p>
        <h2>Payment</h2>
        <p>
        ...
        <p>
          ...
          process. Any timeframe provided by Cricket West London Store for when the
          ...
          are beyond our control. Cricket West London Store cannot be held liable for late
        ...
        <h2>Returns</h2>
        <p>
          Once an order has been placed and accepted by Cricket West London Store, customer
          may not cancel such accepted order without Cricket West London Store’s prior
          ...
          expenses. The product(s) must be returned to Cricket West London Store within
        ...
        <p>
          ...
          indemnify and hold Cricket West London Store harmless from and against any and all
        ...
        <p style={{ fontWeight: "500" }}>Cricket West London Store</p>
        <p style={{ fontWeight: "500" }}>St Mary's Road, London, United Kingdom</p>
        <p style={{ fontWeight: "500" }}>
          Email:{" "}
          <span style={{ fontWeight: "400" }}>info@Criceketwestlondon.com</span>
        </p>
      </div>
    </div>
  );
