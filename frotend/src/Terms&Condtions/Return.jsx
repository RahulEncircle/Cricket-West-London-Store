  ...
  return (
    <div className="container__0">
      ...
      <div className="content-container">
        <p>
          Thank you for shopping with Cricket West London Store! We want to ensure your
        ...
        <p>
          ...
          support@cricketwestlondon.com
          <br />
          <span style={{ fontWeight: "500" }}>Phone  </span>:  07436961184
          <br />
